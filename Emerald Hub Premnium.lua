local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/ImHuySteve/SteveHub-Premnium/main/SteveHub%20Premnium.lua"))
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))()
--------------------------------------------------------------------------------------------------------------------------------------------
local Window = Fluent:CreateWindow({
    Title = "ESP Hub Premnium",
    SubTitle = "Script by STESP TEAM",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://16352980503"
...
local function YTZCAJC_fake_script()
	...
	local function updateInput(input)
		...
		local position = UDim2.new(startPos.X.Scale, startPos.X.Offset + delta.X,Fluxus
